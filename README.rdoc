...
Requirements were (I changed my app to soccer teams instead of bog creatures):
...
Gracefully handle bad urls /asdfsafsfasf,

Error 404 - page not found /creatures/sfasfdsadf,

Error 404 - creature not found /creatures/99999/edit,
...
creature.name should be unique be required not contain numbers or symbols creature.description should be required be between 10 and 255 characters